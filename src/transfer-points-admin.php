...
<p>TRANSFER POINTS</p>
<form method="POST" action="scripts/transferpointsadmin.inc.php">
<p>
  <label for="number3">Transfer FROM Account Number:</label>
  <input type="number" name="from_account_number" id="number3">
</p>
<p>
